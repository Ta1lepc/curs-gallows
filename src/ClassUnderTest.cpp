...
int ClassUnderTest::doSomething() {
...
bool ClassUnderTest::test1(int ch) {
    if (ch != 1 && ch != 2) return false;
    return true;
}

bool ClassUnderTest::test2(ifstream &dict) {
    if (!dict) {
        return false;
    }
    else {
...
bool ClassUnderTest::GamePlay(char star[10],char word[10],int letter) {
